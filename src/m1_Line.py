...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        sumstartPoint = Point((self.start.x + other_line.start.x),(self.start.y + other_line.start.y))
        sumendPoint = Point((self.end.x + other_line.end.x),(self.end.y + other_line.end.y))
        return Line(sumstartPoint,sumendPoint)
    ...
    def line_minus(self, other_line):
        ...
        difstartPoint = Point((self.start.x - other_line.start.x),(self.start.y - other_line.start.y))
        difendPoint = Point((self.end.x - other_line.end.x),(self.end.y - other_line.end.y))
        return Line(difstartPoint,difendPoint)
    ...
    def is_parallel(self, line2):
        ...
        if round(selfl,12) == round(line2l, 12):
            return True
        else:
            return False
    ...
    def reset(self):
        ...
        return Line(self.initstart,self.initend)
